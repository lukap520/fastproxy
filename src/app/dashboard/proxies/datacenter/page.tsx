                        ...
                        <div style={{ padding: "22px", display: "flex", flexDirection: "column", gap: 18 }}>
                            ...
                            {billingType === "bandwidth" ? (
                                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                                    <p style={{ fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.7)", fontFamily: "var(--font-sans,system-ui)" }}>Bandwidth</p>
                            ...
                            <button type="button" disabled={create.isPending || (billingType === "bandwidth" && (!canAfford || activeGb <= 0))}
